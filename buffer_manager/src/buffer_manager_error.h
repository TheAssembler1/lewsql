...
class BufferManagerError : public std::exception {
    ...
    const char* what() const noexcept override {
        switch(error_code) {
        case BufferManagerErrorCode::UNKOWN_ERROR: return "buffer manager unknown error"; break;
        case BufferManagerErrorCode::OUT_OF_MEMORY: return "buffer manager out of memory"; break;
        case BufferManagerErrorCode::PAGE_NOT_FOUND: return "buffer manager page not found"; break;
        case BufferManagerErrorCode::DISK_NOT_FOUND: return "buffer manager disk not found"; break;
